...
export const propertiesExcluding = memoize(exclude => {
  let updatedModel = model;
  exclude.forEach(name => updatedModel = removePropFromModel(name, updatedModel));
...
export const propertiesExcludingWidth = propertiesExcluding(['width', 'min-width', 'max-width']);
/**
...
export const propertiesExcludingHeight = propertiesExcluding(['height', 'min-height', 'max-height']);
/**
...
export const propertiesExcludingSize = propertiesExcluding(['width', 'min-width', 'max-width', 'flex-basis', 'height', 'min-height', 'max-height']);