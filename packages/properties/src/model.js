const layoutProps = [
...

  {
    name: 'margin',
    children: [
      { name: 'margin-top', shorthand: 'margin' },
      { name: 'margin-right', shorthand: 'margin' },
      { name: 'margin-bottom', shorthand: 'margin' },
      { name: 'margin-left', shorthand: 'margin' },
    ],
  },
  { name: 'width' },
  { name: 'min-width' },
    ...
    children: [
      {
        name: 'grid-column',
        children: [
          { name: 'grid-column-start', prefixes: ['-ms-grid-column'] },
          { name: 'grid-column-end', prefixes: ['-ms-grid-column-span'] },
        ],
      },
      {
        name: 'grid-row',
        children: [
          { name: 'grid-row-end', prefixes: ['-ms-grid-row-span'] },
          { name: 'grid-row-start', prefixes: ['-ms-grid-row'] },
        ],
      },
    ],
  },
